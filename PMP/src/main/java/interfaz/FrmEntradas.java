...
public class FrmEntradas extends javax.swing.JInternalFrame {
    ...
    public FrmEntradas(JFrame frmP) {
        initComponents();
        this.contenedor = frmP;
        this.CONTROL = new EntradaControl();
        this.paginar();
        this.listar("",false);
  ...
  cboNumPagina.setSelectedIndex(0);
    ...
    modeloDetalle = new DefaultTableModel(){
        ...
        public Object getValueAt(int row, int col){
            ...
            if(col == 5){
                Double cant;
                try {
                    cant = Double.parseDouble((String)getValueAt(row,3) ); 
                } catch (Exception e) {
                    cant = 1.0;
                }
                
                Double precioD =Double.parseDouble((String)getValueAt(row,4) ); 
                if(cant!=null && precioD!=null){
                return String.format("%.3f",cant * precioD);
    ...
    modeloDetalle.setColumnIdentifiers(new Object[]{"ID","Codigo","Articulo","Cantidad","Precio","SubTotal"});
    ...
    private void CAlcular_Totales(){
        ...
        total = 0;
            ...
            for (int i = 0; i < Items; i++) {
                total = total + Double.parseDouble(String.valueOf(modeloDetalle.getValueAt(i,5)));
            }
    ...
    public void agregarDetalle(String id,String codigo, String nombre, String precio){
        String idtemp;
        ...
        this.modeloDetalle.addRow(new Object[]{id,codigo,nombre,"1",precio,precio});
    ...
    private void initComponents() {
        ...
        IdProvedor = new javax.swing.JTextField();
        ...
        jLabel17.setText("Entradas Almacen");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(36, 36, 36)
                                .addComponent(IdProvedor, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNombreprovedor, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btnProvedor, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(IdProvedor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(txtNombreprovedor.getText().length()== 0 || txtNombreprovedor.getText().length()>70){
            ...
            txtNombreprovedor.requestFocus();
           return;
        }
             
        if(IdProvedor.getText().length()== 0 || IdProvedor.getText().length()>10){
        ...
        String resp = "";
           resp = this.CONTROL.insertar(Integer.parseInt(IdProvedor.getText()),(String)cboComprobante.getSelectedItem(),txtFactura.getText(),txtNUMComprobante.getText(),Double.parseDouble(txtTotalImpuesto.getText()),Double.parseDouble(txtTotal.getText()),modeloDetalle);
                if(resp.equals("OK")){
    ...
    private void btnProvedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProvedorActionPerformed
        FrmselecionarProvedorCompra frm = new FrmselecionarProvedorCompra(contenedor, this, true);
        frm.toFront();
    ...
    private void txtArticuloKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtArticuloKeyReleased
        ...
        if(txtArticulo.getText().length() > 0 ){
            ...
            if(evt.getKeyCode()==KeyEvent.VK_ENTER){
                ...
                art = this.CONTROL.ObtenrArticuloCodigoIngreso(txtArticulo.getText());
                ...
                this.agregarDetalle(Integer.toString(art.getId_articulo()), art.getCodigo_barrar(), art.getNombre(), Double.toString(art.getPrecio_venta()));
    ...
    private void btnVerdetalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerdetalleActionPerformed
        ...
        IdProvedor.setText(id);
        txtNombreprovedor.setText(id_provedor);
    ...
    public javax.swing.JTextField IdProvedor;
