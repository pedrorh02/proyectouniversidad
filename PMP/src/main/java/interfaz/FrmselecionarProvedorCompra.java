 ...
 */
public class FrmselecionarProvedorCompra extends javax.swing.JDialog {
    ...
    public FrmselecionarProvedorCompra(java.awt.Frame parent,FrmEntradas frm, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.vista = frm;
        this.setTitle("Selecione un provedor para el ingreso");
  ...
  cboNumPagina.setSelectedIndex(0);
    ...
    private void btnNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevo1ActionPerformed
        ...
        if(tablaListado.getSelectedRowCount()==1){
            String id = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 0));
            String nombre = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 2));
            this.vista.IdProvedor.setText(id);
            this.vista.txtNombreprovedor.setText(nombre);
