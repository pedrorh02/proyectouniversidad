...
public class FrmProvedor extends javax.swing.JInternalFrame {
  ...
  cboNumPagina.setSelectedIndex(0);
    ...
    if(paginar==true){
    tablaListado.setModel(this.CONTROL.listarTipo(texto, totalporpagina, numPagina,"Provedor"));
    } else{      
    tablaListado.setModel(this.CONTROL.listarTipo(texto,this.totalporpagina,1,"Provedor"));
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (this.accion.equals("editar")){
            resp = this.CONTROL.actualizar(Integer.parseInt(txtid.getText()),"Provedor",txtNombre.getText(),this.nombreAnt,(String)cboTipoDocumento.getSelectedItem(),txtdnumdocumento.getText(),txtDirecion.getText(),txttelefono.getText(),txtemail.getText());
                if(resp.equals("OK")){
            ...
            resp = this.CONTROL.insertar("Provedor",txtNombre.getText(),(String)cboTipoDocumento.getSelectedItem(),txtdnumdocumento.getText(),txtDirecion.getText(),txttelefono.getText(),txtemail.getText());
                if(resp.equals("OK")){
